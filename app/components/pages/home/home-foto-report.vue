    ...
    <div class="root-component">
      ...
      <div :class="carouselContainer">
        <div class="foto-report" :class="carouselClass">
          <ReportImg class="carousel-item" :bgImg="balloons" />
          <ReportImg class="carousel-item" :bgImg="belongings" />
          <ReportImg class="carousel-item" :bgImg="skyscraper" />
          <ReportImg class="carousel-item" :bgImg="coast" />
          <ReportImg class="carousel-item" :bgImg="canyon" />
          <ReportImg class="carousel-item" :bgImg="copybook" />
        </div>
      </div>
